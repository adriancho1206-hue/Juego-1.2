...
const contadorMovimientos = document.getElementById("movimientosJuego3Juego3")
...
return <svg viewBox='0 0 40 40' width='34' height='34'><polygon points='20,4 24,16 37,15 26,24 30,36 20,28 10,36 14,24 3,16 16,16' fill='#d1435b'></polygon></svg>
...
interior.className = "carta-inferior"

const frente = document.createElement("div");
frente.className = "carta-interior"
frente.innerHTML = crearSgSimbolo(simbolo);
...
if (paresEncontrados === simbolos.lenght) {
